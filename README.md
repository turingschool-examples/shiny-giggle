...
You have been provided with the tests for the interaction pattern below.  To complete iteration 1, debug the given classes to make those tests pass! You should not need to update the tests, only the classes (until you get to iteration 2!)
...
Use TDD to update your tests and classes to respond to the following interaction pattern.  
...
Use TDD to update your tests and classes to include the following functionality. You must complete at least 2 of the 3 methods to pass. If you have time, we suggest doing all 3. 
